      ...
      <div className="container" style={{ paddingTop: 120, paddingBottom: 100, position: 'relative', zIndex: 1 }}>
        <div className="grid-2" style={{ alignItems: 'center' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 28 }}>
            <div className="hero-pol-main" style={{ background: '#fff', borderRadius: 6, padding: '12px 12px 38px', boxShadow: '0 16px 48px rgba(10,36,115,0.32)', width: 360 }}>
              <img src="https://images.unsplash.com/photo-1499856871958-5b9627545d1a?w=600&q=80" alt="París"
                style={{ width: '100%', height: 210, objectFit: 'cover', borderRadius: 3, display: 'block' }} />
              <div style={{ fontSize: 15, fontWeight: 700, color: '#1a09b6ff', marginTop: 12, textAlign: 'center' }}>París, Europa 🗺️</div>
            </div>
            <div style={{ display: 'flex', gap: 16 }}>
              <div className="hero-pol-a" style={{ background: '#fff', borderRadius: 6, padding: '10px 10px 32px', boxShadow: '0 12px 36px rgba(10,36,115,0.25)', width: 172 }}>
                ...
                <div style={{ fontSize: 13, fontWeight: 700, color: '#1a09b6ff', marginTop: 10, textAlign: 'center' }}>Nueva York 🗽</div>
              </div>
              <div className="hero-pol-b" style={{ background: '#fff', borderRadius: 6, padding: '10px 10px 32px', boxShadow: '0 12px 36px rgba(10,36,115,0.25)', width: 172 }}>
                <img src="https://images.unsplash.com/photo-1552074284-5e88ef1aef18?w=400&q=80" alt="Cancún"
                  style={{ width: '100%', height: 110, objectFit: 'cover', borderRadius: 2, display: 'block' }} />
                <div style={{ fontSize: 13, fontWeight: 700, color: '#1a09b6ff', marginTop: 10, textAlign: 'center' }}>Cancún 🏖️</div>
              </div>
            </div>
          </div>
        </div>
