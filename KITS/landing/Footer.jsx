        ...
        <div className="footer-grid"> 
          ...
          <div>
            ...
            <div style={{ display:'flex', alignItems:'center', gap:12, marginBottom:20 }}>
              <img src="./assets/ISOLOGO.png" alt="Descúbrela Travel" 
                   style={{ width:60, height:"auto", borderRadius:8, objectFit:'contain', display:'block', flexShrink:0 }} />
                   
              {/* Aquí va tu imagen con las letras */}
              <img src="./assets/DESCUBRELA.png" alt="DescubreLA Travel" 
                   style={{ height: '35px', width: 'auto', objectFit: 'contain' }} />
            </div>

            <p style={{ fontSize:13, fontWeight:400, color:'rgba(255,255,255,0.60)', lineHeight:1.75, marginBottom:24, maxWidth:240 }}>
